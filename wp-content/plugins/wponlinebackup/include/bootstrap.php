...
$WPOnlineBackup_Perform_Check_Once = false;
...
class WPOnlineBackup_BootStrap
{
	...
	{
		global $WPOnlineBackup_Perform_Check_Once;

		// Check we haven't already run once during this PHP session
		if ( $WPOnlineBackup_Perform_Check_Once === true ) return;
		$WPOnlineBackup_Perform_Check_Once = true;
